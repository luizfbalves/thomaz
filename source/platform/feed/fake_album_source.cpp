...
namespace {
// JPEG 2x2 válido (fundo surface_2 #22242D), gerado e verificado com um decoder
// real. Usado como thumbnail/imagem de exemplo no desktop — o stb_image do
// Borealis decodifica sem problema.
const std::vector<std::uint8_t> kTinyJpeg = {
    ...
    0x5A,0x28,0xA2,0xB4,0x24,0xFF,0xD9
};
} // namespace
