...
// Verified verbatim against exelix11 key_loader.cpp @ 2618b0c, which cites:
//   Atmosphere-NX/Atmosphere 693fb42 libstratosphere
//   source/fssrv/fssrv_nca_crypto_configuration.cpp (header KEK/key sources).
// These are the WRAPPED sources SPL GenerateAesKek/GenerateAesKey turn into the
// real header key on-device — NOT the final key (EXTRACT-04, T-01-04).
